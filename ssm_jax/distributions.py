...
def niw_posterior_update(niw_prior, sufficient_stats):
    ...
    return NormalInverseWishart(loc=loc_pos, mean_concentration=precision_pos, df=int(df_pos), scale=scale_pos)
...
def iw_posterior_update(iw_prior, sufficient_stats):
    ...
    return InverseWishart(df=int(df_pos), scale=scale_pos)
