...
class PendulumSimulation():
    def __init__(self):
        ...
        self.dynamics_function = lambda x: jnp.array([x[0] + x[1]*self.dt,
                                                      x[1] - g*jnp.sin(x[0])*self.dt])
        self.dynamics_covariance = jnp.array([[q_c*self.dt**3/3, q_c*self.dt**2/2],
                                              [q_c*self.dt**2/2,      q_c*self.dt]])
